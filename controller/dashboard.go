...
// @Accept  json
// @Produce  json
// @Param days query int true "Number of days to keep (delete older records)"
// @Success 200 {object} models.Response
// @Failure 400 {object} models.Response
// @Failure 401 {object} models.Response
// @Security ApiKeyAuth
// @Router /admin/data/clean-history [delete]
func CleanOldHistory(c *gin.Context) {
	...
	if err != nil || days <= 0 || days > 3650 {
		c.JSON(http.StatusBadRequest, gin.H{"error": "days must be between 1 and 3650"})
		return
	}
	...
	res := services.CleanOldHistory(days)
...
// @Accept  json
// @Produce  json
// @Param days query int true "Number of days to archive (move to archive table)"
// @Success 200 {object} models.Response
// @Failure 400 {object} models.Response
// @Failure 401 {object} models.Response
// @Security ApiKeyAuth
// @Router /admin/data/archive-history [post]
func ArchiveOldHistory(c *gin.Context) {
	daysStr := c.Query("days")
	if daysStr == "" {
		c.JSON(http.StatusBadRequest, gin.H{"error": "days parameter is required"})
		return
	...
	res := services.ArchiveOldHistory(days)
	...
	c.JSON(http.StatusOK, gin.H{"message": "History archive completed successfully"})
}
...
// @Accept  json
// @Produce  json
// @Param date query string false "Target date (YYYY-MM-DD, default: yesterday)"
// @Success 200 {object} models.Response
// @Failure 401 {object} models.Response
// @Security ApiKeyAuth
// @Router /admin/data/create-aggregates [post]
func CreateDailyAggregates(c *gin.Context) {
	targetDate := c.DefaultQuery("date", "")
	...
	res := services.CreateDailyAggregates(targetDate)
...
// @Failure 401 {object} models.Response
// @Security ApiKeyAuth
// @Router /admin/data/storage-stats [get]
